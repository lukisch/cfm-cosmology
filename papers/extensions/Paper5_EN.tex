...
\keywords{quantum gravity, saturation dynamics, axiomatic cosmology, conditional No-Go theorem, Curvature Relaxation Model, tanh universality, renormalization group}
...
\begin{enumerate}
\item \textbf{A conditional No-Go theorem:} Any cosmological theory satisfying Axioms~A--D, B', $D^\pm$, and projective boundary-quotient normalization D' must produce $\tanh$-type saturation. Without D', the same structural hypotheses produce the Abel/collar structure.
