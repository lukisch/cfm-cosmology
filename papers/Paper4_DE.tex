...
\textit{Unabh\"angige Best\"atigung.} Eine unabh\"angige thermodynamische Herleitung von Brodie~\cite{Brodie2026} erh\"alt $a_0 = cH_0/6 \approx 1{,}09 \times 10^{-10}$\,m/s$^2$ aus Verschr\"ankungs-Aufteilung zwischen dem lokalen Rindler-Horizont und dem kosmologischen Hubble-Horizont. Der geometrische Faktor $1/6$ ergibt sich aus dem Winkel\"uberlappungsintegral $\int \cos^2\theta\,d\Omega$ \"uber die Hemisph\"are. Beide analytischen Vorhersagen -- $1/(2\pi) \approx 0{,}159$ (CRM) und $1/6 \approx 0{,}167$ (Brodie) -- liegen innerhalb der empirischen Unsicherheit von $a_0^{\mathrm{obs}}$ und unterscheiden sich um nur $5\%$ voneinander. Dass zwei konzeptionell verschiedene thermodynamische Rahmenwerke (Skalarfeld-Fourier-Dualit\"at vs.\ Horizont-Verschr\"ankungs-Partition) unabh\"angig $a_0$ ohne freie Parameter reproduzieren, legt stark nahe, dass $a_0 \sim cH_0$ echte Physik widerspiegelt und kein numerischer Zufall ist. Ein diskriminierender Test unter Verwendung der vollst\"andigen SPARC-Datenbank -- Vergleich von $\chi^2$ f\"ur $a_0 = cH_0/(2\pi)$ vs.\ $a_0 = cH_0/6$ vs.\ freies $a_0$ -- bleibt zuk\"unftiger Arbeit vorbehalten. F\"ur einen umfassenden ph\"anomenologischen \"Uberblick \"uber die $a_0 \sim cH_0$-Koinzidenz siehe Famaey \& McGaugh~\cite{FamaeyMcGaugh2012}.
...
Die Konvergenz zweier unabh\"angiger Rahmenwerke auf dieselbe $a_0$-Relation -- hier aus dem S\"attigungs-ODE-Attraktor und der Fourier-Frequenzumrechnung (Abs.~\ref{sec:a0_derivation}), bei Kovacs aus thermodynamischer Temperaturgleichheit -- st\"arkt den Hinweis auf physikalische Signifikanz. Drei Vergleichspunkte sind besonders relevant:
