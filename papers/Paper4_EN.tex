...
\begin{table*}[tbp]
\caption{\label{tab:galactic_status}Status of the galactic field equations in the CRM vector sector. Three levels of epistemic confidence are distinguished.}
\begin{ruledtabular}
\begin{tabular}{ll}
...
\textit{Established:} Scaling & Deep-MOND $\sqrt{g_{\mathrm{bar}} a_0}$ attractor via Chameleon feedback (Sec.~\ref{sec:bvp_results}) \\
